...
def test_inheritance_init():
    ...
    try:
        b.append("orange")
    except AttributeError :  #what happened here?   #   The append method of b tries to access an attribute a1, but b doesn't have any attribute called a1
        pass
...
Python includes inheritance, a prominent feature of object oriented programming languages
Syntax for performing inheritance in Python
We can access the super-class of a sub-class by using the super() function
"""
