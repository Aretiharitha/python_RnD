...
def get_scrabble_scorer():
    return {y : x[0] for x in scrabble_scores for y in x[1]}
    pass
...
Comprehensions can be used to obtain lists, dicts, and sets from other such sequences easily and in a compact manner
How nested and conditional comprehensions can be used
How to create and use comprehensions for various sequences
"""
