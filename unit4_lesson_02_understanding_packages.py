...
def test_package_import_failure():
    ...
    why_it_failed = "Because package2 doesn't have an __init__.py file which is used to initialize Python packages"
...
def test_package_sub_packages():
    ...
    # why is this not raising an exception here?     # because we have imported the package subpackage from package1 and hence it is considered as the base in this case
...
How packages and subpackages are imported
Packages require an __init__.py file inside them to initialize
How to access modules inside packages and subpackages
"""
