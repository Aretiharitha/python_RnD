...
def test_decorators_func_arguments():
    ...
    assert 30 == add(10, 20)
    print(test_logs)
    assert ["Entered: add","Entered: add"] == test_logs
...
-Decorators can be used to change how other functions behave
-We can use the @ symbol before a function to use a decorator on it
-We can use functools.wraps to preserve a decorated function's name and documentation
"""
