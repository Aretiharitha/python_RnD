...
The lambda keyword can be used to create small single line anonymous functions
They're extremely useful in real-time programming when passing small functions as parameters
They have the syntax: lambda <passed value> : <return value>
"""