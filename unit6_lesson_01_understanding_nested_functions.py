...
-In Python, nested functions have only read-only access to the outer variables
-Inner functions can be returned as objects to the function which calls the outer function
-Scoping rules apply to function names similar to variables
"""
